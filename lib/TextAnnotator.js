...
var Split = function (props) {
    ...
    return props.mark ? react_1["default"].createElement(MarkClass, __assign({}, props)) : (react_1["default"].createElement("span", { "data-start": props.start, "data-end": props.end, onClick: function () { return props.onClick({ start: props.start, end: props.end }); } }, props.content));
};
var TextAnnotator = function (props) {
    ...
    return (react_1["default"].createElement("div", { style: style, onMouseUp: handleMouseUp }, splits.map(function (split) { return (react_1["default"].createElement(Split, __assign({ key: split.start + "-" + split.end, customMark: customMark }, split, { onClick: handleSplitClick }))); })));
};
